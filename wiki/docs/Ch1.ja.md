...
* `debug` モードで POI を起動します（Brave も Manifest V2 のサポートを終了したため、KC3 とはお別れです QAQ）
...
## 起動手順 (Start Up)
**Beginner**（初心者）、**Gamer**（ゲーマー）、**Developer**（開発者）のいずれかから選択してください。
