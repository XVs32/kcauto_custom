...
class NavNodes(object):
    def __init__(self):
        ...
        self.home.define_connection(
            ...
            "QUEST_MENU",
            "left",
            "quest|filter_tab_all_active.png",
            KCSAPIEnum.QUEST_LIST,
        )
        self.home.define_connection(
            self.sortie,
            "home_menu",
            "nav|home_menu_sortie.png",
            "side_menu",
            "nav|side_menu_fleetcomp.png",
        )
        self.home.define_connection(
            self.fleetcomp,
            "home_menu",
            "nav|home_menu_fleetcomp.png",
            "upper",
        ...
        self.home.define_connection(
            self.resupply,
            "home_menu",
            "nav|home_menu_resupply.png",
            "lower_right",
            "resupply|resupply_all_done.png",
        )
        self.home.define_connection(
            self.equipment,
            "home_menu",
            "nav|home_menu_equipment.png",
            "lower_right",
            "nav|screen_equipment_ready.png",
        )
        self.home.define_connection(
            self.repair,
            "home_menu",
            "nav|home_menu_repair.png",
            "upper_left",
            "nav|screen_repair_ready.png",
            KCSAPIEnum.REPAIR_DOCKS,
        )
        self.home.define_connection(
            self.development,
            "home_menu",
            "nav|home_menu_development.png",
            "upper_left",
            "nav|screen_development_ready.png",
        )

        self.top_menu.define_connection(
            self.home,
            "lower_left",
            "nav|top_menu_home.png",
            "home_menu",
            "nav|home_menu_sortie.png",
            KCSAPIEnum.PORT,
        )
        ...
        self.sortie.define_connection(
            self.combat,
            "kc",
            "nav|sortie_menu_combat.png",
            "top_submenu",
            "nav|sortie_top_menu_combat_active.png",
            KCSAPIEnum.SORTIE_MAPS,
        )
        self.sortie.define_connection(
            self.pvp,
            "kc",
            "nav|sortie_menu_pvp.png",
            "top_submenu",
            "nav|sortie_top_menu_pvp_active.png",
            KCSAPIEnum.PVP_LIST,
        )
        self.sortie.define_connection(
            self.expedition,
            "kc",
            "nav|sortie_menu_expedition.png",
            "top_submenu",
            "nav|sortie_top_menu_expedition_active.png",
        ...
        self.combat.define_connection(
            self.expedition,
            "top_submenu",
            "nav|sortie_top_menu_expedition.png",
            "top_submenu",
            "nav|sortie_top_menu_expedition_active.png",
            KCSAPIEnum.EXPEDITION_LIST,
        )
        self.pvp.define_connection(
            self.combat,
            "top_submenu",
            "nav|sortie_top_menu_combat.png",
            "top_submenu",
            "nav|sortie_top_menu_combat_active.png",
            KCSAPIEnum.SORTIE_MAPS,
        )
    ...
    def navigate_to(self, target, api_update=True):
        ...
        if target in self.connections:
            ...
            if c["click_target"] == "QUEST_MENU":
                ...
                Log.log_debug_1(
                    f"click {c['click_target']} in {c['click_target_region']}"
                )
            ...
            kca_u.kca.wait(
                kca_u.kca.r[c["wait_target_region"]], c["wait_target"], 20, NEAR_EXACT
            )
            if target == "home":
            ...
            Log.log_msg(
                f"Not possible to navigate to '{target}' from {self.name} screen."
            )
            return False
