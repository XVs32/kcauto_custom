...
class KCSAPIEnum(EnumBase):
    ...
    SORTIE_ECF_NIGHTBATTLE = "kcsapi/api_req_combined_battle/ec_midnight_battle"
    ...
    SORTIE_CF_EACH_NIGHT_ONLY = "kcsapi/api_req_combined_battle/each_sp_midnight"
    ...
    SORTIE_CF_ECF_WATERBATTLE = "kcsapi/api_req_combined_battle/each_battle_water"
    SORTIE_CF_ECF_LD_AIRBATTLE = "kcsapi/api_req_combined_battle/each_ld_airbattle"
    SORTIE_CF_ECF_LD_SHOOTING = "kcsapi/api_req_combined_battle/each_ld_shooting"
