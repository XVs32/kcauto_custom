...
RECIPE_PRESET_DEVELOP_TEMPLATE = "template|data|factory|develop_recipe_preset.json"

GIMMICK = "data|temp|gimmick.json"
GIMMICK_TEMPLATE = "template|data|temp|gimmick.json"
